			...
			<div class="hy_right">
				<div class="hy_right_bt">
					<ul class="menu1" id="menu">
						<li class="hit"><a href="javascript:void(0)" onclick="document.location.href='${ctx }/member/list?param=member'">普通会员推荐</a></li>
						<li class=""><a href="javascript:void(0)" onclick="document.location.href='${ctx }/member/list?param=credit'">信贷经理推荐</a></li>
					</ul>
				</div>
				<s:form commandName="reinfo" method="post" action="${ctx }/member/recommendctr/findMember" id="member_recommmend_form">
					<s:hidden path="membertopage" id="member_recommmend_topage"/>
						...
						<tbody class="h_z">
							<c:forEach items="${pageMember.data }" var="member" varStatus="vs">
								<tr>
									...
									<td colspan="2">${member.registerTime }</td>
									<%-- 
